...
USAGE = './lemma_overlap_CIEP.py <source_directory> <target_directory> [-h]'
...
def count_overlap_lemmas(source,outfilename,languages,only_nouns):
    outfile = open(outfilename, "w")
    outfile.write("language" + "\t" + "lemmas_overlap" + "\t" + "lemmas_total" + "\t" + "lemmas_overlap_weighted" + "\t" + "lemmas_total_weighted" + "\n")
    #This is identical to the previous dictionary
...
def main():
    ...
    count_overlap_lemmas(args.source,args.target+"-all",languages,False)
    count_overlap_lemmas(args.source,args.target+"-onlynouns",languages,True)
